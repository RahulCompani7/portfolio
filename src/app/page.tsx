    ...
    <>
      <AuroraBackground className=" h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col justify-center items-center">
          <section className="section w-full flex-1 flex flex-col justify-center items-center">
            <div className="section__container h-full w-full flex flex-col xl:flex-row justify-between items-center p-20 mt-52 xl:mt-0">
              <div className="content text-center flex flex-col justify-center items-center xl:items-start xl:text-start">
                ...
                <p className="description hidden sm:block">
                  ...
                  extraordinaire, I spend my days sprinkling pixels with magic
                  and turning lines of code into works of art. But when I&apos;m
                  not crafting digital wonders, you&apos;ll catch me riding the
                  waves of the latest tech trends, sharing my wisdom with eager
              ...
              <div className="flex justify-center items-center flex-col mt-4 xl:mt-0 ">
                ...
                <div className="flex sm:hidden social-icons-container  justify-center items-center mt-4">
                  <div className="social-icons flex gap-4">
                    <a
                      href="https://www.linkedin.com/in/rahul-compani-713a12210"
                      target="_blank"
